...
function fileLoaded(file){
	...
	senten = file + '';
	str = split(senten, '.');
	select("#paradive").html("Press Enter to dive deeper into Verona.");
	select("#paratype").html("Type something you like about Romeo and Juliet:");
...
function setup() {
	loadStrings('rajwow123.txt', fileLoaded, progress, error);
}
