...
function fileLoaded(file){
	...
	senten = file + '';
	str = split(senten, '.');
	select("#paradive").html("Press Enter to dive deeper into Maycomb County.");
	select("#paratype").html("Type something you like about To Kill a Mockingbird:");
...
function setup() {
	loadStrings('tkambwow123.txt', fileLoaded, progress, error);
}
