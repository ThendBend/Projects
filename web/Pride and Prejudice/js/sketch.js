...
function fileLoaded(file){
	...
	senten = file + '';
	str = split(senten, '.');
	select("#paradive").html("Press Enter to dive deeper into Longbourn.");
	select("#paratype").html("Type something you like about Pride and Prejudice:");
...
function setup() {
	loadStrings('papwow123.txt', fileLoaded, progress, error);
}
