...
function fileLoaded(file){
	...
	senten = file + '';
	str = split(senten, '.');
	select("#paradive").html("Press Enter to dive deeper into Westessos.");
	select("#paratype").html("Type something you like about Game of Thrones:");
...
function setup() {
	loadStrings('gotwow123.txt', fileLoaded, progress, error);
}
