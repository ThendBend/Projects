...
function fileLoaded(file){
	...
	senten = file + '';
	str = split(senten, '.');
	select("#paradive").html("Press Enter to dive deeper into Long Island.");
	select("#paratype").html("Type something you like about The Great Gatsby:");
...
function setup() {
	loadStrings('tggwow123.txt', fileLoaded, progress, error);
}
